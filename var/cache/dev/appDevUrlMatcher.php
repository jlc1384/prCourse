...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // test_nativedql_with_model_action
        if ($pathinfo === '/nativedqlwithmodel') {
            return array (  '_controller' => 'FirstBundle\\Controller\\DefaultController::nativeDQLWithModelAction',  '_route' => 'test_nativedql_with_model_action',);
        }

        // test_form_action
        if ($pathinfo === '/addcourse') {
            return array (  '_controller' => 'FirstBundle\\Controller\\DefaultController::addCourseAction',  '_route' => 'test_form_action',);
        }
