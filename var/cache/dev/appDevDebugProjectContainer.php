...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.twig_filter_helper' => 'getApp_TwigFilterHelperService',
    ...
    /**
     * Gets the 'app.twig_filter_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FirstBundle\Twig\FilterVista A FirstBundle\Twig\FilterVista instance
     */
    protected function getApp_TwigFilterHelperService()
    {
        return $this->services['app.twig_filter_helper'] = new \FirstBundle\Twig\FilterVista();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'prcursodb', 'user' => 'prcurso', 'password' => 'prcurso', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\FirstBundle\\Resources\\config\\doctrine') => 'FirstBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('FirstBundle' => 'FirstBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dd68d3a50847a32cde51a7f6ae91ebbe49cc534af88e6dac2fe1cd706d22705b');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('app.twig_filter_helper'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ba33266665617ea9bf2cc6cf62cccdfe964772b4');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'\\src\\FirstBundle\\Resources\\config\\validation.yml')));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a5b8cfe99ce34.90497111')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'prcursodb',
            'database_user' => 'prcurso',
            'database_password' => 'prcurso',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ba33266665617ea9bf2cc6cf62cccdfe964772b4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ba33266665617ea9bf2cc6cf62cccdfe964772b4',
